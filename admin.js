let listings = JSON.parse(localStorage.getItem("listings"))
  ...
  : [
      ...
      },
      {
        ...
        bedrooms: "1",
        price: "$2,800/mo",
        img: "./assets/car-10.jpg",
        locations: "Chicago",
        location: "1625 Southern Street,  New York(NY), 11530",
        type: "Apartment",
        bathroom: "1",
        parking: "1",
        size: "2360 Sq Ft",
      },
      {
        ...
        bedrooms: "3",
        price: "$5,200/mo",
        img: "./assets/car-11.jpg",
        locations: "Miami",
        location: "1765 Long Street,  Florida(FL), 32749",
        type: "Apartment",
        bathroom: "1",
        parking: "1",
        size: "2450 Sq Ft",
      },
      {
        ...
        bedrooms: "4",
        price: "$1,600/mo",
        img: "./assets/car-12.jpg",
        locations: "Miami",
        location: "2360 George Avenue,  Florida(FL), 32056",
        type: "Apartment",
        bathroom: "2",
        parking: "1",
        size: "4300 Sq Ft",
